...
class HandleProjects extends Component {
      ...
      render(){
        ...
        if (this.props.Type==="projects") {
          ...
          return(
            <div>
              <li onClick={()=>{if(this.props.selected!="featured"){this.props.setSelected("featured")}else if(this.props.selected!="web"){this.props.setSelected("web")}} }>Broken {this.props.Type}</li>
